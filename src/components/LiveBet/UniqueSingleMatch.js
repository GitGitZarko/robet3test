                                                                    ...
                                                                    <Table.Row textAlign='center'>
                                                                        <Table.Cell
                                                                            style={{
                                                                                ...
                                                                                background: `${oddIdList.includes(ata.OddId) ? 'red' : ''}`,
                                                ...
                                                data.Odds.map((ata, k) => {
                                                    return (
                                                        <Table.Cell textAlign='center' style={{ padding: 0, background: '#424242', color: 'white', fontWeight: 600 }}>
                                                            {ata.OddLabel}
                                                            <Table>
                                                                {/* style={{ background: `${oddIdList.includes(ata.OddId) ? 'red' : ''}` }} */}
...
const mapStateToProps = ({ liveBetGames, singleMatchLive, changeOddValue, oddIdList }) => ({ liveBetGames, singleMatchLive, changeOddValue, oddIdList })
