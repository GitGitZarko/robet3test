...
class ChampNameMobile extends Component {
    constructor(props) {
        super(props)
...
export default connect(mapStateToProps, { fetchChampList, addChampToList, removeChampFromList, sportViewChamps, removeSingleMatch })(ChampNameMobile);
